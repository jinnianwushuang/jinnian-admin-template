...
<template>
  <div class="q-px-md">
    ...
    >
      <q-card style="width:80vw ;min-width:600px;min-height:600px" class=" ">
        <q-card-section>
      <div class="row">
      ...
      <q-separator/>
        ...
        <q-card-section class="q-pt-none q-gutter-y-sm">
              <q-scroll-area style="min-height: 330px;  height:550px" class="full-width ">
          ...
          <div class="row">
            <div class="form-label">姓名</div>
             <!-- <div class="col"> </div> -->
            <div class="col"> <q-input   outlined dense v-model="editing_obj.name"> </q-input> </div>
            ...
            <div class="col"> 
            <q-input outlined dense v-model="editing_obj.age"> </q-input></div>
          </div>
                    <div class="row">
            ...
            <div class="col">
            <q-checkbox v-model="editing_obj.married" /> </div>
          
          </div>
                    <div class="row">
            <div class="form-label">国籍</div>
            <div class="col"> 
            <q-input outlined dense v-model="editing_obj.nationality"> </q-input></div>
          </div>
                    <div class="row">
            <div class="form-label">地址</div>
            <div class="col"> 
            <q-input outlined dense v-model="editing_obj.address"> </q-input></div>
          </div>
                    <div class="row">
            <div class="form-label">电话</div>
            <div class="col"> 
            <q-input outlined dense v-model="editing_obj.tel"> </q-input></div>
          </div>
                    <div class="row">
            <div class="form-label">爱好</div>
            <div class="col"> 
            <q-input outlined dense v-model="editing_obj.hobby"> </q-input></div>
          </div>
                              <div class="row">
            <div class="form-label">描述</div>
            <div class="col">
            <q-input outlined dense v-model="editing_obj.description"> </q-input> </div>
          </div>

                    <div class="row">
            <div class="form-label">标签</div>
            <div class="col"> 
            <q-input outlined dense v-model="editing_obj.remark"> </q-input></div>
          </div>
